...
export default function FanArtPage() {
  return (
    <ComingSoonContent
      title="Fan Art"
      description="Bộ sưu tập nghệ thuật do fan sáng tác về Tru Tiên và Lực Tuyết Kỳ"
      features={[
        "Gallery fan art chất lượng cao",
        "Tranh vẽ Lức Tuyết Kỳ",
        "Illustration các nhân vật",
        "Manga/Comic fan-made",
        "Digital art và traditional art",
        "Wallpaper và avatar"
      ]}
    />
  );
...
export const metadata = {
  title: "Fan Art - Blog Lực Tuyết Kỳ Tuyết Mê",
  description: "Bộ sưu tập nghệ thuật do fan sáng tác về Tru Tiên và Lực Tuyết Kỳ"
};
