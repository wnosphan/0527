...
function ComingSoonContent({ title, description, features }: ComingSoonPageProps) {
  return (
...
export default function CotTruyenPage() {
  return (
    <ComingSoonContent
      title="Cốt Truyện"
      description="Phân tích chi tiết cốt truyện và các sự kiện quan trọng trong Tru Tiên"
      features={[
        "Tóm tắt từng tập của Tru Tiên",
        "Phân tích các sự kiện quan trọng",
        "Timeline chi tiết của cốt truyện",
        "Mối quan hệ nhân quả trong truyện",
        "Các plot twist và điểm nhấn",
...
export const metadata = {
  title: "Cốt Truyện - Blog Lực Tuyết Kỳ Tuyết Mê",
  description: "Phân tích chi tiết cốt truyện và các sự kiện quan trọng trong tác phẩm Tru Tiên"
};
