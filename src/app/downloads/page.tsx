...
export default function DownloadsPage() {
  return (
    <ComingSoonContent
      title="Downloads"
      description="Tải về các tài liệu, hình ảnh và nội dung liên quan đến Tru Tiên"
      features={[
        "E-book Tru Tiên (miễn phí)",
        "Wallpaper chất lượng cao",
        "Avatar và icon",
        "Nhạc theme và soundtrack",
        "Tài liệu phân tích",
        "Template và resources"
      ]}
    />
  );
}
...
export const metadata = {
  title: "Downloads - Blog Lực Tuyết Kỳ Tuyết Mê",
  description: "Tải về các tài liệu, hình ảnh và nội dung liên quan đến Tru Tiên"
};
